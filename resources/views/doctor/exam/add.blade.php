        ...
        <div class="slide slide-1 row" style="display: block">
            <table class="table" >
                ...
                <tr>
                    <td>{{ __('start_time') }} *</td>
                    <td>
                        <input name="start_time" type="datetime" required="" class="form-control" value="{{ date('Y-m-d H:i:s') }}"  >
                    </td>
                </tr>
                <tr>
                    <td>{{ __('end_time') }} *</td>
                    <td>
                        <input name="end_time" type="datetime" required="" class="form-control"  value="{{ date('Y-m-d H:i:s') }}"  >
                    </td>
                </tr>
                <tr>
                    <td>{{ __('minutes') }} *</td>
