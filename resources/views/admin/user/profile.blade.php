            ...
            <div class="box-body box-profile">
              ...
              <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                  <b>{{ __('exams') }}</b> <a class="pull-right">{{ number_format(Auth::user()->toStudent()->studentExams()->count()) }}</a>
                </li>
                <li class="list-group-item">
                ...
                <li class="list-group-item">
                  <b>{{ __('researches') }}</b> <a class="pull-right">{{ number_format(Auth::user()->toDoctor()->exams()->count()) }}</a>
                </li>
                <li class="list-group-item">
